  ...
  fluidPage(
    ...
    sidebarLayout(
       ...
       (
        ...
        fluidRow(column(6,numericInput("Bl","Body length (cm):",value=NA,min = 0.01, max = 10000,step=0.01)),
            column(width=6,numericInput("GSI","Gonadosomatic index (GSI):",value=NA,min = 0, max = 1,step=0.001))),
