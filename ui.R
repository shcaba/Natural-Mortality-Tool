    ...
    conditionalPanel(
      condition="input.conditionedPanels==1",
        ...
        fluidRow(column(width=6,numericInput("Amax", "Longevity (yrs):", value=NA,min=0.1, max=300, step=0.1)),
            column(width=6,numericInput("Age_in","Age (yr) specified for Chen-Wat:", value=NA,min=0.1, max=300, step=0.01))),    
        fluidRow(column(width=6,numericInput("Linf","VBGF Linf (in cm):", value=NA,min=1, max=10000, step=0.01)),
            column(6,numericInput("k_vbgf", "VBGF k:", value=NA,min = 0.001, max = 1,step=0.01))),    
        fluidRow(column(width=6,numericInput("t0", "VBGF t0", value=NA,min = -15, max = 15,step=0.01)),
